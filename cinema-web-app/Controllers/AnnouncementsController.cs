...
public class AnnouncementsController : Controller
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        if (User.Identity.IsAuthenticated)
        {
            ...
            userCinemaId = user?.ContentCinemaAdmins?.FirstOrDefault()?.CinemaId;
        }
    ...
    public async Task<IActionResult> Create(
        [Bind("Id,CinemaId,UserId,Title,Message,PublicationDate")] Announcement announcement)
    {
        ...
        var cinemaId = await _context.ContentCinemaAdmins.Where(c => c.UserId == announcement.UserId)
            .Select(c => c.CinemaId).FirstOrDefaultAsync();
    ...
    {
        var announcement = await _context.Announcements.FindAsync(id);
        if (announcement != null) _context.Announcements.Remove(announcement);
